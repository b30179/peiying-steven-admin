...
2. `D:\ZM\AI工坊\某中学\Steven岗位AI实施方案_整合版_v3.1_2026-07-15.docx`：Steven 业务方案。
3. `D:\ZM\AI工坊\某中学\Steven需求对照审计_v1_2026-07-15.md`：对 design.md 的审计修订项与 Phase 1 门禁。
4. `D:\ZM\AI工坊\04-项目提案\最终实施参考文档\Steven整合实施设计_v3_2026-07-15.md`：历史设计细节，仅作参考。

所有新建、修改、代码、前端原型、测试、文档均写入：`D:\ZM\AI工坊\某中学\`。历史 `04-项目提案` 只读，不写入新产出。
